    ...
    NeonHeart.prototype = {
	    ...
	    function StarParticle(x, y, garden) {
	        ...
	        this.particles = [];
	        // 增加环绕小星点数量，让填充更密集
	        var count = Garden.randomInt(7, 9); // 从5-7提升到7-9
	    ...
	    StarParticle.prototype = {
	        draw: function () {
	            ...
	            for (var i = 0; i < this.particles.length; i++) {
	                ...
	                gradient.addColorStop(0, 'rgba(' + r + ', ' + g + ', ' + b + ', ' + (0.65 * twinkle) + ')'); // 透明度从0.6提升到0.65
	    ...
	    FlowingLight.prototype = {
	        draw: function () {
	            ...
	            for (var i = 0; i < this.trails.length; i++) {
	                ...
	                var alpha = (i / this.trails.length) * 0.18; // 从0.28降到0.18
	            ...
	            mainGradient.addColorStop(0, 'hsla(' + this.hue + ', 40%, 96%, 0.4)');  // 从0.6降到0.4
	            mainGradient.addColorStop(0.3, 'hsla(' + this.hue + ', 38%, 88%, 0.28)'); // 从0.42降到0.28
	            mainGradient.addColorStop(0.6, 'hsla(' + this.hue + ', 35%, 80%, 0.15)'); // 从0.22降到0.15
	            ...
	            // 白色核心（更柔和的高光）
	            ctx.fillStyle = 'rgba(255, 255, 255, ' + (pulse * 0.35) + ')'; // 从0.55降到0.35
	            ctx.beginPath();
